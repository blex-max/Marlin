...
#define SENSORLESS_BACKOFF_MM  { 20, 20, 0 }  // (mm) Backoff from endstops before sensorless homing
...
#define LIN_ADVANCE
  ...
  //#define EXPERIMENTAL_SCURVE   // Enable this option to permit S-Curve Acceleration  blex : for now
